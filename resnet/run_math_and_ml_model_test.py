...
from utils.custom_dataset_meta_regression_loo import Carbon
from utils.resnet14_meta import ResNet, BasicBlock
from utils.training_utils_meta_regression import validate
...
ml_best_model_params_path = os.path.join('pretrained_models', 'math_and_ml_best_model_params_seed7.pt')
...
print(f"Math&ML model testing: correlation: {valid_epoch_acc:.3f}, R2: {valid_r2:.3f}, MSE: {valid_epoch_loss:.3f}")